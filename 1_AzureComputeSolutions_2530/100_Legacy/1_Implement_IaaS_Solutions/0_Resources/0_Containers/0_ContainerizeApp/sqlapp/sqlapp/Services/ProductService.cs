...
namespace sqlapp.Services
{
    ...
    public class ProductService : IProductService
    {
        ...
        public List<Product> GetProducts(bool noDbUSe = true)
        {
            if (noDbUSe)
            {
                return new List<Product>
                {
                    new Product { ProductID = 1, ProductName = "Motix", Quantity = 15 },
                    new Product { ProductID = 1, ProductName = "Batx", Quantity = 15 },
                    new Product { ProductID = 1, ProductName = "Nolak", Quantity = 15 }
                };
            }
